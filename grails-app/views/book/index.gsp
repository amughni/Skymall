		...
		<div id="list-book" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="prodName" title="${message(code: 'book.prodName.label', default: 'Prod Name')}" />
				...
				<g:each in="${bookInstanceList}" status="i" var="bookInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${bookInstance.id}">${fieldValue(bean: bookInstance, field: "prodName")}</g:link></td>
