...
<body>
	...
	<div class="nav" role="navigation">
		<ul>
			...
			<li><g:link controller="book" action="list"
			...
			<g:if test="${session.user.userRole == 'Shopper'}">
				<li><g:link controller="cart" action="addProduct"
						params="[pid: bookInstance.id, uid: session.user.id]">
		...
		<ol class="property-list book">
			<g:if test="${bookInstance?.image}">
				<li class="fieldcontain"><span id="image-label"
					class="property-label"><g:message code="book.image.label"
			...
			<g:if test="${bookInstance?.prodName}">
				<li class="fieldcontain"><span id="prodName-label"
					class="property-label"><g:message code="book.prodName.label"
							default="Prod Name" /></span> <span class="property-value"
					aria-labelledby="prodName-label"><g:fieldValue
							bean="${bookInstance}" field="prodName" /></span></li>
			</g:if>
			...
			<g:if test="${bookInstance?.price}">
				<li class="fieldcontain"><span id="price-label"
					class="property-label"><g:message code="book.price.label"
							default="Price" /></span> <span class="property-value"
					aria-labelledby="price-label"><g:fieldValue
							bean="${bookInstance}" field="price" /></span></li>
			</g:if>

			<g:if test="${bookInstance?.subCategory}">
				<li class="fieldcontain"><span id="subCategory-label"
					class="property-label"><g:message
							code="book.subCategory.label" default="Sub Category" /></span> <span
					class="property-value" aria-labelledby="subCategory-label"><g:fieldValue
							bean="${bookInstance}" field="subCategory" /></span></li>
			</g:if>
