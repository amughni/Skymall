...
<div class="fieldcontain ${hasErrors(bean: electronicsInstance, field: 'specList', 'error')} ">
	<label for="specList">
		<g:message code="electronics.specList.label" default="Spec List" />
		
	</label>
	<g:textField name="specList" value="${electronicsInstance?.specList}"/>
