		...
		<div id="list-electronics" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="specList" title="${message(code: 'electronics.specList.label', default: 'Spec List')}" />
				...
				<g:each in="${electronicsInstanceList}" status="i" var="electronicsInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: electronicsInstance, field: "specList")}</td>
