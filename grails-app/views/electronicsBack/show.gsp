	...
	<body>
		...
		<div id="show-electronics" class="content scaffold-show" role="main">
			...
			<ol class="property-list electronics">
				...
				<g:if test="${electronicsInstance?.specList}">
				<li class="fieldcontain">
					<span id="specList-label" class="property-label"><g:message code="electronics.specList.label" default="Spec List" /></span>
					
						<span class="property-value" aria-labelledby="specList-label"><g:fieldValue bean="${electronicsInstance}" field="specList"/></span>
